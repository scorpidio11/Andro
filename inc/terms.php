...
<div id="termsModal" class="reveal-modal" data-reveal>
 <h2>Terms and Conditions</h2> 
 <p>Scroll and Read Below</p>
 <div class="CodeRay">
  <div>
   <p class="lead">1. SCOPE &amp; APPLICATION</p>

    <p>1.1 You expressly agree and accept the Conditions set forth herein unconditionally as a binding contract ("the Agreement") enforceable by law. The following are the terms and conditions of participation in the <?php echo $LLproductName ?> Subscription ("Subscription") or any other Product on this Site, all such references to Subscription or Product combined shall be ("Product"). "Customer", "I", "You" or "Your" refers to you. "Site" means this World Wide Website located at the URL <?php echo $siteurl ?>. <?php echo $companyname ?> dba <?php echo $LLproductName ?> ("We", "Us" or "Our") reserves the right to amend this Agreement from time to time. It is agreed that any such amendment will apply to Customer. <?php echo $companyname ?> agrees to inform Customer of any amendment to the agreement. Should Customer fail to object to any amendment to the Agreement within one week, such failure shall serve as an acceptance of the amendment.</p>
    
    <p>2. AUTO SHIPMENTS AND BILLING</p>
    
    <p>2.1 By placing your order you will be receiving a 14 day evaluation of <?php echo $LLproductname ?> for the price of $<?php echo $trialprice ?>! We stand by our satisfaction Guarantee and our friendly customer service. You will also be enrolling into our convenient auto ship program once your evaluation expires. You understand that you are subscribing to a monthly shipment program and you will be charged $<?php echo $recurprice ?> per month starting 14 days from today and every 30 days thereafter unless cancelled. You also understand that you can cancel at any time, subject to the provisions of section 3, without further obligation by calling <?php echo $companyphone ?>, Monday - Friday between the hours of <?php echo $hours ?>. Your transaction will appear on your credit card statement as "<?php echo $CCdescriptor ?>". You will recieve your package within 2-5 business days of each payment. Please allow 2-5 Business days for your initial Bottle.</p>
    
    <p>2.2 By placing your order with pre-paid card payment, you will be enrolling into our convenient auto ship program. You understand that you are subscribing to a monthly shipment program and you will be charged <?php echo $prepaidprice ?> per month starting  from today and every 30 days thereafter unless canceled. You also understand that you can cancel at any time, subject to the provisions of section 3, without further obligation by calling <?php echo $companyphone ?>, Monday - Friday between the hours of 9am-5pm MST. You will receive your package within 2-5 business days of each payment. Please allow 2-5 Business days for your initial Bottle.</p>

    <p>2.3 You authorize Us to initiate debit/credit entries to your credit card as indicated upon enrollment. This authority is to remain in full force and effect until You cancel Your auto shipment.</p>    
    
    <p>2.4 If Your payment is not approved by credit card within 30 days of the due date, Your Subscription will be suspended. If You wish to cancel and not be billed, You must call toll-free at <?php echo $companyphone ?>. You expressly agree to the automatic 30 day billing set forth herein. You expressly agree to honor all charges and fees due in association with this Subscription(s).</p>

<p>2.5 Payment Cache and  Security:

You understand that subscription enrollment applies to the bank, debit card, or credit card account that You designate. You acknowledge that the bank, debit card, or credit card account that you designated, will be Cached until you terminate the subscription(s).

It is encrypted through the Payment Card Industry Data Security Standard (PCI). Your purchase transaction data is stored only as long as is necessary to complete your purchase transaction. PCI-DSS requirements help ensure the secure handling of credit card information by our store and its service providers.
If you provide us with your credit card information, the information is encrypted using secure socket layer technology (SSL). We follow all PCI requirements and implement additional generally accepted industry standards.<p>

    <p class="lead">3. RETURNS, CANCELLATION AND REFUND POLICY</p>    
    
    <p>3.1 I also understand that I can cancel at any time, subject to the provisions of section 3, without further obligation by calling <?php echo $companyphone ?>. If you cancel within the first 13 days you will not be charged again, and you will not receive multiple packages unless you place another order on this site. On the 14th day after your initial order (if you have not called us to cancel) the trial period will end and we will process payment for your first auto shipment.</p>
        
    <p>3.2 REFUND POLICY. This exclusive offer is being made available to those persons willing to evaluate the product and determine its effectiveness. Customer agrees to try the product and evaluate its performance before requesting a refund or cancellation. Please call Customer Care at <?php echo $companyphone ?> to make arrangement to receive Your refund. Shipping and handling fees are non-refundable.</p>
    
    <p>3.3 You explicitly agree to the following statement: "I UNDERSTAND THAT I MAY BE LIABLE FOR PAYMENT OF FUTURE GOODS AND SERVICES UNDER THE TERMS OF THIS AGREEMENT IF I FAIL TO NOTIFY THE SUPPLIER NOT TO SUPPLY THE GOODS OR SERVICES DESCRIBED."</p>
    
    <p>3.4 RMA (Return Merchandise Authorization) numbers are required for all returns and are available upon request by calling customer service. RMA numbers will be issued within 2 business days. Returns are subject to a <?php echo $restockingFee ?> restocking fee. Return products in their original, unopened package within 30 days of shipment to:</p>
      
    <p><?php echo $LLproductName ?>
          
    <br /><?php echo $returnaddress ?> 
          
    <br /><?php echo $returncity ?>, <?php echo $returnstateabv ?> <?php echo $returnzip ?></p>
          
    <p>3.5 Persons with a medical condition, who are pregnant, or have reason to believe they may become pregnant in the next 60 days should not order this product. Refunds will not be accepted and refunds will not be given for these reasons. You must consult a physician prior to placing an order if you are unsure about whether you can take this product.</p>
    
    <p class="lead">4. DISPUTE RESOLUTION</p>
    
    <p>4.1 You expressly agree to submit in writing any objection regarding fees to:<br /><br /> 
    <?php echo $LLproductName ?><br />
    <?php echo $companyaddress ?><br />
    <?php echo $companycity ?>, <?php echo $stateabv ?> <?php echo $companyzip ?></p>
    
    <p>4.2 <?php echo $companyname ?>, in its sole discretion, shall determine the validity of Your objection and notify You of its decision. Should You disagree with <?php echo $companyname ?>'s decision, You agree to mediate the dispute before litigation.</p>

    <p>4.3 You agree to indemnify for any financial harm or any losses caused by Your objections to fees that does not comply with this Section. You will be held responsible for the reimbursement of any fees and losses incurred as a result of Your failure to comply with any provision in this Agreement.</p>

    <p>4.4 Credit Card Billing Customer expressly agrees that if Customer pays by credit card, check or demand debit, Customer shall abide by the following statement: "I hereby authorize to initiate debit/credit entries to my bank deposit account or credit card."</p>
    
    <p class="lead">5. OFFER, ACKNOWLEDGMENT AND ACCEPTANCE</p>

    <p>5.1 Any prices, quotations and descriptions made or referred to on this Site are subject to availability, do not constitute an offer and may be withdrawn or revised at any time prior to our express acceptance of Your order (as described below).</p>
    
    <p>5.2 While we make every effort to ensure that items appearing on the Site are available, we cannot guarantee that all items are in stock or immediately available when you submit your order. We may reject Your order (without liability) if We are unable to process or fulfill it. If this is the case, We will refund any prior payment that you have made for that item.</p>
    
    <p>5.3 An order submitted by You constitutes an offer by You to Us to purchase the Subscription on these Conditions and is subject to Our subsequent acceptance.</p> 
        
    <p>5.4 Prior to such acceptance, an automatic e-mail acknowledgement of Your order may be generated. Please note that any such automatic acknowledgement does not constitute a formal acceptance of Your order.</p>
    
    <p>5.5 Our acceptance of Your order takes effect and the contract concluded at the point where such offer is expressly accepted by Us dispatching Your order and accepting Your credit card or other payment ("Acceptance").
    ...
    <p class="lead">6. YOUR REPRESENTATIONS</p>  
    ...
    <p>6.2 No warranty, commitment or any other obligation should ever be assumed by You on Our behalf or on behalf of a Product manufacturer, licensor or supplier without Our express prior written consent.</p>
    ...
    <p>6.7 You agree to pay for taxes, shipping or carriage of Products as such costs are specified by Us on the Site when You submit Your purchase order. Payment shall be made prior to delivery and by such methods as are indicated on the Site (and not by any other means unless we have given our prior agreement). </p>
    ...
    <p>6.10 Where the payment is invoiced, each invoice shall be due on and made in full within thirty (30) days of the date of relevant invoice. If at any time you fail to pay any amount due on the relevant due date, We may by notice declare all invoiced amounts unpaid at that date to be immediately due and payable. No counterclaim or set-off may be deducted from any payment due without our written consent. We may also take action against You for the price of Products at any time after payment has become due even though property in those Products may not yet have passed to you.</p>

    <p>6.11 Any extension of credit allowed to You may be changed or withdrawn at any time. Interest shall be chargeable on overdue amounts accruing on a daily basis at the maximum amount permitted under applicable law from the due date for payment until our receipt of the full amount (whether before or after judgment). You shall indemnify Us on demand against any out of pocket expenses incurred in relation to recovery of any overdue amounts.</p>
    
    <p class="lead">7. TERMINATION</p>
    ...
    <p>7.1.1 Stop any Products in transit; and/or<br />
    7.1.2 Suspend further Product deliveries; and/or<br />
    7.1.3 Stop or suspend provision of Services; and/or<br />
    7.1.4 By written notice, terminate Your order and all or any other contracts between Us and You.</p>
    
    <p class="lead">8. DELIVERY AND RISK</p> 

    <p>8.1 Delivery timescales/dates specified on the Site, in any order acknowledgement, acceptance or elsewhere are estimates only. While We endeavor to meet such timescales or dates, We do not undertake to dispatch Products and/or commence Services by a particular date or dates and shall not be liable to You in respect of delays or failure to do so.</p>
    ...
    <p>8.3.1 We shall be entitled to immediate payment in full for the Products or Services delivered and either to effect delivery by whatever means We consider appropriate or to store Products at Your risk;<br />
    8.3.2 You shall be liable pay on demand all costs of Product storage and any additional costs incurred as a result of such refusal or failure to take delivery; and<br />
    8.3.3 We shall be entitled 30 days after the agreed date for delivery to dispose of Products in such manner as We determine and may set off any proceeds of sale against any sums due from You.</p> 
    ...
    <p>8.5 Where We deliver Products by installments, each installment constitutes a separate contract and any defect in any one or more installments shall not entitle You to repudiate the contract as a whole nor to cancel any subsequent installment. 
   
    <p>8.6 Save as otherwise provided in these Conditions, risk of loss of or damage to the Products passes to You on delivery or when placed in your possession or that of any carrier or transport provided by You, whichever shall occur first. 
    
    <p class="lead">9. REJECTION, DAMAGE OR LOSS IN TRANSIT</p>
    ...
    <p class="lead">10. LIABILITY LIMITATION</p>
    ...
    <p>10.2 <?php echo $companyname ?>, in its sole discretion, shall not be liable for a chance occurrence or unavoidable or uncontrollable accident beyond either parties control that prevents our ability to fulfill obligations under the contract.</p>

    <p class="lead">11. THIRD PARTY RIGHTS</p>
    
    <p>11.1 You shall indemnify Us against any and all liabilities, claims and costs incurred by or made against Us as a direct or indirect result of us performing Services or carrying out any work on or to the Products where this has been done to Your (or Your representative's) specific requirements or specifications causing an infringement or alleged infringement of any proprietary rights of any third party.</p>
    ...
    12. WARRANTY "AS IS" IN GENERAL – WITHOUT REGARD TO SEPARATE WARRANTY STATEMENTS PACKAGED BY THE MANUFACTURER WITH THE PRODUCTS.</p>
    ...
    12.3.3 Defects are due (wholly or partially) to mistreatment, improper use or storage or maintenance or installation, or failure to observe any manufacturers' instructions or other directions issued or made available by Us in connection with the delivered Products.</p>
    ...
    <p class="lead">13. CONSENTS, CUSTOMS DUTIES & EXPORT</p>
    ...
    14.1.1 In relation to hand delivery, on the date of delivery at the relevant address (or, if this is not a working date, the first working date thereafter);<br />
    14.1.2 If posted, 5 working days after the date of posting;<br />
    ...
    <p class="lead">15. PERSONAL INFORMATION AND YOUR PRIVACY</p>
    
    
    <p>15.1 We will observe applicable data protection laws and will not use information that does or can be used to personally identify You ("Personal Data") other than as set out in Our Privacy Policy ("Privacy Policy"). By submitting Your Personal Data in relation to Your order, You consent to such Personal Data being processed to fulfill Your order and in accordance with such Privacy Statement.</p>
    
    
    <p class="lead">16. GENERAL</p>
    ...
    <p>16.5 No waiver of any term or condition of these Conditions shall be effective unless made in writing and signed by Us. The waiver of any breach of any Condition shall not be construed as a waiver of any subsequent breach or condition. 
    ...
    <p>16.6.1 These Conditions will not be affected in other jurisdictions to the extent that such determination or finding has no application; and<br />
    16.6.2 In the relevant jurisdiction, the remainder of these Conditions (to the fullest extent permitted by law) will continue in full force and effect.</p> 
    
    <p class="lead">17. GOVERNING LAW</p> 
    
    <p>17.1 The construction validity and performance of these Conditions shall be governed by US Law and You agree to submit to the exclusive jurisdiction of the <?php echo $companystate ?> Courts, in the event of legal proceedings arising from any dispute; The language of any dispute resolution procedure or any proceedings will be English.</p>



 <p class="lead">18. DISPUTE RESOLUTION PROCEDURE</p> 

 
    <p>18.1 Your purchase or use of Company products constitutes your agreement to this Dispute Resolution Procedure. If you do not agree to the arbitration agreement in this Dispute Resolution Procedure, you must return the product for a refund within 30 days of the date of delivery of the product.</p>

 <p>18.2 Arbitration Agreement. You and Company agree that this arbitration agreement is made pursuant to a transaction involving interstate commerce and shall be governed by the Federal Arbitration Act ('FAA'), and not by any state law concerning arbitration; and that any dispute between us, including disputes by either of us against any agent, officer, shareholder, member, employee, subsidiary, affiliate, predecessor in interest, successor and/or assign of the other, will be resolved exclusively and finally by binding arbitration.</p>



 <p>18.3 BY AGREEING TO THIS ARBITRATION AGREEMENT, YOU ARE GIVING UP YOUR RIGHT TO GO TO COURT, INCLUDING YOUR RIGHT TO A JURY TRIAL In arbitration, a dispute is resolved by a neutral arbitrator or panel of arbitrators, rather than by a judge or jury. Arbitration is more informal, however, an arbitrator can award the same relief that a court can award. If you initiate an arbitration, Company will promptly reimburse you for any standard filing fee which may have been required under Procedures once you have notified Company in writing and provided a copy of the arbitration proceedings. The prevailing party in the arbitration shall be entitled to attorneys' fees and costs, including the filing fee.</p>



 <p>18.4 There shall be no right or authority for any claim to be arbitrated on a class action basis or in a purported representative capacity. No claim submitted to arbitration is heard by a jury or may be brought as a private attorney general. You do not have the right to act as a class representative or participate as a member of a class of claimants with respect to any claim submitted to arbitration. The arbitrator may not consolidate more than one person's claims against Company and may not preside over any kind of representative or class proceeding against Company, its agents, officers, shareholders, members, employees, subsidiaries, affiliates, predecessors in interests, successors and/or assigns. You acknowledge that this class action waiver is material and essential to the arbitration of any disputes between the parties and is nonseverable from the agreement to arbitrate claims. If any portion of this class action waiver is limited, voided, or cannot be enforced, then the parties' agreement to arbitrate shall be null and void. YOU UNDERSTAND THAT BY AGREEING TO THIS ARBITRATION AGREEMENT, WHICH CONTAINS THIS CLASS ACTION WAIVER, YOU MAY ONLY BRING CLAIMS AGAINST Company, ITS AGENTS, OFFICERS, SHAREHOLDERS, MEMBERS, EMPLOYEES, SUBSIDIARIES, AFFILIATES, PREDECESSORS IN INTEREST, SUCCESSORS AND/OR ASSIGNS IN AN INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS ACTION OR REPRESENTATIVE PROCEEDING. IF YOU HAVE ALREADY PURCHASED A PRODUCT AND YOU DO NOT AGREE TO THE FOREGOING TERMS AND CONDITIONS, YOU MUST TELL US IN WRITING AND RETURN THE PRODUCT TO GET A REFUND PRIOR TO USE. IF YOU HAVE PURCHASED THE PRODUCT AT A RETAIL STORE, YOU MUST RETURN THE PRODUCT ACCORDING TO THE STORE'S RETURN POLICY. IF YOU HAVE PURCHASED THE PRODUCT BY TELEPHONE OR ONLINE FROM US, YOU MUST RETURN THE PRODUCT PURSUANT TO OUR RETURN POLICY</p>
  </div>
 </div>
