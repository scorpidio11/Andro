...
function() {
        ...
        c.fn.dfoSlider = function(b) {
            var d = c(this),
                e = c.extend({
                    ...
                    leftArrowClass: "slider-left-arrow",
                    rightArrowClass: "slider-right-arrow",
        ...
        var d = {},
            ...
            f = {
                ...
                setScrollVars: function() {
                    d.$window = c(a), d.windowHeight = c(a).height(), d.docHeight = f.getDocHeight(), d.$bar = c("#bottom-floating-bar"), d.$topbar = c("#top-floating-bar"), d.$form = c("#index-form"), d.formHeight = d.$form.outerHeight(), d.topbarHeight = d.$topbar.outerHeight()
                },
                trackScroll: function() {
                    c(a).on("load resize", f.setScrollVars), c(a).on("scroll resize", function() {
                        d.$bar.length && (d.$window.width() < 1024 && d.$window.scrollTop() >= 2 && d.$window.scrollTop() + d.windowHeight < d.docHeight - d.formHeight - 500 ? d.$bar.css("cssText", "display: block !important;") : d.$bar.css("cssText", "display: none !important;")), d.$topbar.length && (d.$window.width() >= 1025 && d.$window.scrollTop() + d.topbarHeight < d.docHeight - d.formHeight - d.topbarHeight ? d.$topbar.css("cssText", "display: block !important;") : d.$topbar.css("cssText", "display: none !important;"))
                    })
                },
    ...
    function(a, b, c) {
        ...
        var d = a.SITE.helpers,
            ...
            g = {
                ...
                landing: {
                    init: function() {
                        d.initUnveil(), d.setDatesInDOM(), e.initForm(c("#register-form"), "registerForm"), d.fillCanvasInfo(), f.hookRunner("landing"), d.setClockStopwatch(), d.trackScroll(), d.preventEmptyHref(), d.bindScrollButtons(), new WOW({
                            offset: 20
                        }).init();
                        var g = {
                                endlessLoop: !0,
                            ...
                            i = c("#hero-index");
                        c(".steps-slider").dfoSlider(g);
                        c("#steps-slider2").dfoSlider(g), g.responsive = !1, c("#testimonials-slider").dfoSlider(g), h && i.addClass("loading"), c(a).load(function() {
                ...
                checkout: {
                    init: function() {
                        d.fillCanvasInfo(), d.setDatesInDOM(), d.bindScrollButtons(), d.setClockStopwatch(), c(".try-risk-free").on("click", function() {
                            d.scrollToEl(c(".form-container"))
                        }), d.initUnveil(), new WOW({
                            offset: 20
                        }).init(), f.hookRunner("checkout"), e.initForm(c("#order-form"), "orderForm")
                    }
                },
                confirm: {
                    init: function() {
    ...
    function(a, b, c, d) {
        ...
        var e = function(a) {
            ...
            f = function(d) {
                a.SITE.settings = e(d), c(b).ready(a.SITE.controller.loadEvents)
            };
